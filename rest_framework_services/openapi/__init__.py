...
The framework-agnostic helpers — [`ServiceErrorSerializer`][rest_framework_services.openapi.service_error_serializer.ServiceErrorSerializer],
[`enable_openapi`][rest_framework_services.openapi.enable_openapi.enable_openapi] — live here. Importing this module is safe even
without ``drf-spectacular`` installed; it does not pull in the
schema-generator code itself.
...
Then call [`enable_openapi`][rest_framework_services.openapi.enable_openapi.enable_openapi] once from ``AppConfig.ready()``.
"""
