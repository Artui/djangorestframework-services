...
The framework-agnostic helpers — :class:`ServiceErrorSerializer`,
:func:`enable_openapi` — live here. Importing this module is safe even
...
:mod:`rest_framework_services.openapi.service_auto_schema`. That module
...
Then call :func:`enable_openapi` once from ``AppConfig.ready()``.
"""
