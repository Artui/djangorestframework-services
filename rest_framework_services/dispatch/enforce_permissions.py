...
def enforce_permissions(
    ...
    *,
    ...
    When ``instance`` is supplied, object-level permissions
    ...
    omits this; off-HTTP parity restores it.)
    ...
    for permission_class in spec.permission_classes:
        ...
        if not permission.has_permission(request, view):
            _deny(permission)
        if instance is not None and not permission.has_object_permission(request, view, instance):
            _deny(permission)
