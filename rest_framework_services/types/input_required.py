...
[`RetrieveSelector`][rest_framework_services.selectors.retrieve_selector.RetrieveSelector]
/ the service Protocols — the very reason
[`HttpExtras`][rest_framework_services.types.http_extras.HttpExtras] mandates
