"""``AgentProjection`` — a serializer's agent markings, resolved once."""
...
class AgentProjection:
    ...
    fields: Mapping[str, AgentField] = field(default_factory=dict)
    ...
    nested: Mapping[str, AgentProjection] = field(default_factory=dict)
