...
class ChangeResult(Generic[ModelT]):
    ...
    [`ChildCollectionChange`][rest_framework_services.types.child_collection_change.ChildCollectionChange]
    ...
    def get_field_change(self, field_name: str) -> FieldChange | None:
        """Return the
        [`FieldChange`][rest_framework_services.types.field_change.FieldChange] for
        ``field_name``, or ``None``."""
