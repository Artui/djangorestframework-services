...
class TestRenderableSerializerClass:
...
class TestDataclassSerializerClass:
    def test_one_class_per_dataclass(self) -> None:
        assert dataclass_serializer_class(_Word) is dataclass_serializer_class(_Word)

    def test_every_site_shares_it(self) -> None:
        assert renderable_serializer_class(_Word) is dataclass_serializer_class(_Word)
    ...
    def test_distinct_dataclasses_get_distinct_classes(self) -> None:
        ...
        assert dataclass_serializer_class(_Other) is not dataclass_serializer_class(_Word)
        assert dataclass_serializer_class(_Other).Meta.dataclass is _Other  # ty: ignore[unresolved-attribute]
